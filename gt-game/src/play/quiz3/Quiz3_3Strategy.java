...
public class Quiz3_3Strategy extends Strategy {
    ...
    public void execute() throws InterruptedException {
        ...
        while (true) {
            ...
            while (!playComplete) {
                ...
                LinearProblem linearProblemP1 = getLinearProblemEM7(tree, true);
    ...
    private LinearProblem getLinearProblemEM7(GameTree tree, boolean isPlayerOne) {
